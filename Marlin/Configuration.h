...
#define STRING_CONFIG_H_AUTHOR "(FolgerTech 2020 i3 - cyberkni branch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa 2020 i3"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "5317c37c-17db-460e-90c6-49b2da723fb2"
...
#define Z_RAISE_AFTER_PROBING 10    // Raise before probe stow (e.g., the last probe).
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,7984,190}  // default steps per unit for Ultimaker
...
#define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {110,0}} // X,Y,Z Axis Extend and Retract angles
